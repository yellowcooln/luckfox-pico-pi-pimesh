...
- `build/`: image build entrypoints and fragments. Use [`build/build-image.sh`](/home/yellowcooln/luckfox-pico-pi-pimesh/build/build-image.sh) for full image builds.
